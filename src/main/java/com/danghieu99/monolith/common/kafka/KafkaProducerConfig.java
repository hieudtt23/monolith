...
public class KafkaProducerConfig {
    ...
    @Bean
    public <T extends BaseKafkaRequest> ProducerFactory<String, T> producerObjFactory() {
    ...
    @Bean
    public <T extends BaseKafkaRequest> KafkaTemplate<String, T> kafkaObjTemplate() {
