...
public class SellerShopService {
    ...
    @Transactional
    public GetShopDetailsResponse createCurrentUserShop(@NotNull UserDetailsImpl userDetails,
    ...
    @Transactional
    public GetShopDetailsResponse editCurrentUserShopDetails(@NotNull UserDetailsImpl userDetails,
