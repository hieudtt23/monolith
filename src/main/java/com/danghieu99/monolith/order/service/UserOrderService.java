...
import com.danghieu99.monolith.order.kafka.consumer.RequestCancelOrderKafkaConsumer;
import com.danghieu99.monolith.order.kafka.producer.RequestCancelOrderKafkaProducer;
import com.danghieu99.monolith.order.kafka.producer.UpdateOrderAddressKafkaProducer;
import com.danghieu99.monolith.order.kafka.producer.PlaceOrderKafkaProducer;
...
public class UserOrderService {
    ...
    @Async
    @Transactional
    public void place(@NotNull final UserPlaceOrderRequest request,
    ...
    @Async
    @Transactional
    public void updateOrderAddress(@NotNull final UserUpdateOrderAddressRequest request,
                                   @NotNull final UserDetailsImpl userDetails) {
